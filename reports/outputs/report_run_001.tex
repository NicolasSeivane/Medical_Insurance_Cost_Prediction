...
\begin{itemize}
    \item Model type: DecisionTreeRegressor
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{ ../scoring_results.png }
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{ ../scoring_comparation.png }
